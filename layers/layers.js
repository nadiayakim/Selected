...
var format_Ukrainerecaptured_1 = new ol.format.GeoJSON();
var features_Ukrainerecaptured_1 = format_Ukrainerecaptured_1.readFeatures(json_Ukrainerecaptured_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ukrainerecaptured_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ukrainerecaptured_1.addFeatures(features_Ukrainerecaptured_1);
var lyr_Ukrainerecaptured_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Ukrainerecaptured_1, 
                style: style_Ukrainerecaptured_1,
                interactive: false,
                title: '<img src="styles/legend/Ukrainerecaptured_1.png" /> Ukraine recaptured'
            });
var format_Russianoccupation_2 = new ol.format.GeoJSON();
var features_Russianoccupation_2 = format_Russianoccupation_2.readFeatures(json_Russianoccupation_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Russianoccupation_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Russianoccupation_2.addFeatures(features_Russianoccupation_2);
var lyr_Russianoccupation_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Russianoccupation_2, 
                style: style_Russianoccupation_2,
                interactive: false,
                title: '<img src="styles/legend/Russianoccupation_2.png" /> Russian occupation'
            });
...
var format_Population2024_7 = new ol.format.GeoJSON();
var features_Population2024_7 = format_Population2024_7.readFeatures(json_Population2024_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Population2024_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Population2024_7.addFeatures(features_Population2024_7);
var lyr_Population2024_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Population2024_7, 
                style: style_Population2024_7,
                interactive: false,
    title: 'Population 2024<br />\
    <img src="styles/legend/Population2024_7_0.png" /> 5450 - 7000<br />\
    <img src="styles/legend/Population2024_7_1.png" /> 7000 - 11000<br />\
    <img src="styles/legend/Population2024_7_2.png" /> 11000 - 15000<br />\
    <img src="styles/legend/Population2024_7_3.png" /> 15000 - 26000<br />\
    <img src="styles/legend/Population2024_7_4.png" /> 26000 - 39983<br />'
        });
...
lyr_ESRIGraylight_0.setVisible(true);lyr_Ukrainerecaptured_1.setVisible(true);lyr_Russianoccupation_2.setVisible(true);lyr_Oblasts_3.setVisible(true);lyr_Selected_hromadas_4.setVisible(true);lyr_Settlements_5.setVisible(true);lyr_Nationalroads_6.setVisible(true);lyr_Population2024_7.setVisible(true);lyr_Numberofsettlementsinhromada_8.setVisible(true);lyr_Namesofhromadas_9.setVisible(true);
var layersList = [lyr_ESRIGraylight_0,lyr_Ukrainerecaptured_1,lyr_Russianoccupation_2,lyr_Oblasts_3,lyr_Selected_hromadas_4,lyr_Settlements_5,lyr_Nationalroads_6,lyr_Population2024_7,lyr_Numberofsettlementsinhromada_8,lyr_Namesofhromadas_9];
lyr_Ukrainerecaptured_1.set('fieldAliases', {'Name': 'Name', 'FolderPath': 'FolderPath', 'SymbolID': 'SymbolID', 'AltMode': 'AltMode', 'Base': 'Base', 'Clamped': 'Clamped', 'Extruded': 'Extruded', 'Snippet': 'Snippet', 'PopupInfo': 'PopupInfo', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_Russianoccupation_2.set('fieldAliases', {'Name': 'Name', 'FolderPath': 'FolderPath', 'SymbolID': 'SymbolID', 'AltMode': 'AltMode', 'Base': 'Base', 'Clamped': 'Clamped', 'Extruded': 'Extruded', 'Snippet': 'Snippet', 'PopupInfo': 'PopupInfo', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_Selected_hromadas_4.set('fieldAliases', {'ADM3_EN': 'ADM3_EN', 'ADM3_UA': 'ADM3_UA', 'ADM3_RU': 'ADM3_RU', 'ADM3_PCODE': 'ADM3_PCODE', 'ADM2_EN': 'ADM2_EN', 'ADM2_UA': 'ADM2_UA', 'ADM2_RU': 'ADM2_RU', 'ADM2_PCODE': 'ADM2_PCODE', 'ADM1_EN': 'ADM1_EN', 'ADM1_UA': 'ADM1_UA', 'ADM1_RU': 'ADM1_RU', 'ADM1_PCODE': 'ADM1_PCODE', 'ADM0_EN': 'ADM0_EN', 'ADM0_UA': 'ADM0_UA', 'ADM0_RU': 'ADM0_RU', 'ADM0_PCODE': 'ADM0_PCODE', 'AREA_SQKM': 'AREA_SQKM', 'Admin3_UAn': 'Admin3_UAn', 'Admin3_ENn': 'Admin3_ENn', 'L1_share': 'L1_share', 'L2_share': 'L2_share', 'L3A_share': 'L3A_share', 'L3B_share': 'L3B_share', 'L3C_share': 'L3C_share', 'Occp_share': 'Occp_share', 'ACLED_3y': 'ACLED_3y', 'ACLED_3m': 'ACLED_3m', 'ACLED_3y_D': 'ACLED_3y_D', 'ACLED_3m_D': 'ACLED_3m_D', 'Deoccupied': 'Deoccupied', 'ADM3_type': 'ADM3_type', 'UKRSTAT_22': 'UKRSTAT_22', 'OXFORD_23': 'OXFORD_23', 'MidWntr_24': 'MidWntr_24', 'Haven_II': 'Haven_II', 'Polaris': 'Polaris', 'Recovery_P': 'Recovery_P', 'Strategy': 'Strategy', 'Expressed_': 'Expressed_', 'ObjectID': 'ObjectID', 'Settlem': 'Settlem', 'Off_sites': 'Off_sites', 'Off_Pop': 'Off_Pop', 'Source': 'Source', });
...
lyr_Population2024_7.set('fieldAliases', {'ADM3_EN': 'ADM3_EN', 'ADM3_UA': 'ADM3_UA', 'ADM3_RU': 'ADM3_RU', 'ADM3_PCODE': 'ADM3_PCODE', 'ADM2_EN': 'ADM2_EN', 'ADM2_UA': 'ADM2_UA', 'ADM2_RU': 'ADM2_RU', 'ADM2_PCODE': 'ADM2_PCODE', 'ADM1_EN': 'ADM1_EN', 'ADM1_UA': 'ADM1_UA', 'ADM1_RU': 'ADM1_RU', 'ADM1_PCODE': 'ADM1_PCODE', 'ADM0_EN': 'ADM0_EN', 'ADM0_UA': 'ADM0_UA', 'ADM0_RU': 'ADM0_RU', 'ADM0_PCODE': 'ADM0_PCODE', 'AREA_SQKM': 'AREA_SQKM', 'Admin3_UAn': 'Admin3_UAn', 'Admin3_ENn': 'Admin3_ENn', 'L1_share': 'L1_share', 'L2_share': 'L2_share', 'L3A_share': 'L3A_share', 'L3B_share': 'L3B_share', 'L3C_share': 'L3C_share', 'Occp_share': 'Occp_share', 'ACLED_3y': 'ACLED_3y', 'ACLED_3m': 'ACLED_3m', 'ACLED_3y_D': 'ACLED_3y_D', 'ACLED_3m_D': 'ACLED_3m_D', 'Deoccupied': 'Deoccupied', 'ADM3_type': 'ADM3_type', 'UKRSTAT_22': 'UKRSTAT_22', 'OXFORD_23': 'OXFORD_23', 'MidWntr_24': 'MidWntr_24', 'Haven_II': 'Haven_II', 'Polaris': 'Polaris', 'Recovery_P': 'Recovery_P', 'Strategy': 'Strategy', 'Expressed_': 'Expressed_', 'ObjectID': 'ObjectID', 'Settlem': 'Settlem', 'Off_sites': 'Off_sites', 'Off_Pop': 'Off_Pop', 'Source': 'Source', 'ORIG_FID': 'ORIG_FID', });
...
lyr_Ukrainerecaptured_1.set('fieldImages', {'Name': 'TextEdit', 'FolderPath': 'TextEdit', 'SymbolID': 'TextEdit', 'AltMode': 'Range', 'Base': 'TextEdit', 'Clamped': 'Range', 'Extruded': 'Range', 'Snippet': 'TextEdit', 'PopupInfo': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_Russianoccupation_2.set('fieldImages', {'Name': 'TextEdit', 'FolderPath': 'TextEdit', 'SymbolID': 'TextEdit', 'AltMode': 'Range', 'Base': 'TextEdit', 'Clamped': 'Range', 'Extruded': 'Range', 'Snippet': 'TextEdit', 'PopupInfo': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
...
lyr_Population2024_7.set('fieldImages', {'ADM3_EN': 'TextEdit', 'ADM3_UA': 'TextEdit', 'ADM3_RU': 'TextEdit', 'ADM3_PCODE': 'TextEdit', 'ADM2_EN': 'TextEdit', 'ADM2_UA': 'TextEdit', 'ADM2_RU': 'TextEdit', 'ADM2_PCODE': 'TextEdit', 'ADM1_EN': 'TextEdit', 'ADM1_UA': 'TextEdit', 'ADM1_RU': 'TextEdit', 'ADM1_PCODE': 'TextEdit', 'ADM0_EN': 'TextEdit', 'ADM0_UA': 'TextEdit', 'ADM0_RU': 'TextEdit', 'ADM0_PCODE': 'TextEdit', 'AREA_SQKM': 'TextEdit', 'Admin3_UAn': 'TextEdit', 'Admin3_ENn': 'TextEdit', 'L1_share': 'TextEdit', 'L2_share': 'TextEdit', 'L3A_share': 'TextEdit', 'L3B_share': 'TextEdit', 'L3C_share': 'TextEdit', 'Occp_share': 'TextEdit', 'ACLED_3y': 'TextEdit', 'ACLED_3m': 'TextEdit', 'ACLED_3y_D': 'TextEdit', 'ACLED_3m_D': 'TextEdit', 'Deoccupied': 'TextEdit', 'ADM3_type': 'TextEdit', 'UKRSTAT_22': 'TextEdit', 'OXFORD_23': 'TextEdit', 'MidWntr_24': 'TextEdit', 'Haven_II': 'TextEdit', 'Polaris': 'TextEdit', 'Recovery_P': 'TextEdit', 'Strategy': 'TextEdit', 'Expressed_': 'TextEdit', 'ObjectID': 'Range', 'Settlem': 'TextEdit', 'Off_sites': 'TextEdit', 'Off_Pop': 'TextEdit', 'Source': 'TextEdit', 'ORIG_FID': 'TextEdit', });
...
lyr_Ukrainerecaptured_1.set('fieldLabels', {'Name': 'no label', 'FolderPath': 'no label', 'SymbolID': 'no label', 'AltMode': 'no label', 'Base': 'no label', 'Clamped': 'no label', 'Extruded': 'no label', 'Snippet': 'no label', 'PopupInfo': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Russianoccupation_2.set('fieldLabels', {'Name': 'no label', 'FolderPath': 'no label', 'SymbolID': 'no label', 'AltMode': 'no label', 'Base': 'no label', 'Clamped': 'no label', 'Extruded': 'no label', 'Snippet': 'no label', 'PopupInfo': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
...
lyr_Population2024_7.set('fieldLabels', {'ADM3_EN': 'no label', 'ADM3_UA': 'no label', 'ADM3_RU': 'no label', 'ADM3_PCODE': 'no label', 'ADM2_EN': 'no label', 'ADM2_UA': 'no label', 'ADM2_RU': 'no label', 'ADM2_PCODE': 'no label', 'ADM1_EN': 'no label', 'ADM1_UA': 'no label', 'ADM1_RU': 'no label', 'ADM1_PCODE': 'no label', 'ADM0_EN': 'no label', 'ADM0_UA': 'no label', 'ADM0_RU': 'no label', 'ADM0_PCODE': 'no label', 'AREA_SQKM': 'no label', 'Admin3_UAn': 'no label', 'Admin3_ENn': 'no label', 'L1_share': 'no label', 'L2_share': 'no label', 'L3A_share': 'no label', 'L3B_share': 'no label', 'L3C_share': 'no label', 'Occp_share': 'no label', 'ACLED_3y': 'no label', 'ACLED_3m': 'no label', 'ACLED_3y_D': 'no label', 'ACLED_3m_D': 'no label', 'Deoccupied': 'no label', 'ADM3_type': 'no label', 'UKRSTAT_22': 'no label', 'OXFORD_23': 'no label', 'MidWntr_24': 'no label', 'Haven_II': 'no label', 'Polaris': 'no label', 'Recovery_P': 'no label', 'Strategy': 'no label', 'Expressed_': 'no label', 'ObjectID': 'no label', 'Settlem': 'no label', 'Off_sites': 'no label', 'Off_Pop': 'no label', 'Source': 'no label', 'ORIG_FID': 'no label', });
